...
#OpposingParty
class OpposingPartyBase(BaseModel):
...
class OpposingPartyCreate(OpposingPartyBase): 
...
class OpposingPartyUpdate(OpposingPartyBase):
   pass


class OpposingPartyInDBBase(OpposingPartyBase):
...
class OpposingPartySchema(OpposingPartyInDBBase):
